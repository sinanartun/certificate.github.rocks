	...
	const render_questions = function (data) {
		...
		for (let i = 0; i < data.questions.length; i++) {
			...
			html +=
				...
				'<div class="kt-portlet__head-label">' +
				'<div class="kt-portlet__head-title" style="padding: 0px 22px 0px 2px;">' +
				...
				'<input type="checkbox" name="radio" value="a"';
				...
				'<input type="checkbox" name="radio" value="b"';
				...
				'<input type="checkbox" name="radio" value="e"';
				...
				'<div class="row col-md-12 kt-pb-25 kt-pt10">' +
