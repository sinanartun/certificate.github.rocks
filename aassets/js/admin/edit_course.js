...
const edit_course = function () {
    ...
    let kanban4;
    let cropper;
    const _course_code  = $('#section_div').data('cc');
    kanban4 = new jKanban({
        element: '#section_div',
        gutter: '0',
        click: function (el) {
            ...
            kanban4.addElement(
                section_id,
                {
                    ...
                    'title':
                        ...
                        '</li>' +
                        '<li class="nav-item">' +
                        '<a class="nav-link"  data-toggle="tab" href="#add3_' + lecture_id + '" role="tab" aria-controls="contact" aria-selected="false">Açıklama</a>' +
                        '</li>' +
                        '</ul>' +
                        ...
                        '<div class="tab-pane fade" id="add2_' + lecture_id + '" role="tabpanel" aria-labelledby="profile-tab">' +
                        ...
                        '<div class="tab-pane fade" id="add3_' + lecture_id + '" role="tabpanel" aria-labelledby="contact-tab">' +
                        '<div class="form-group ">' +
                        '<div class="kt-input-icon kt-input-icon--left">' +
    ...
    const handle_image_upload = function () {
        ...
        var myDropzone5 = new Dropzone(id, { // Make the whole body a dropzone
            url: "/aajax/upload_course_image", // Set the url for your upload script location
            parallelUploads: 1,
    ...
    const save_session = function () {
        ...
        let data = {
            ...
            //course_img: $('#add_course_img').attr('src'),
            sections: sections,
            course_code:$('#section_div').data('cc')
        };
...
//return false;
            ...
            for (let i = 0; i < lectures[k].length; i++) {
                  ...
                  let title2 =
                    ...
                    '<span class="lecture_div" >' +
                      ...
                      '</li>' +
                      '<li class="nav-item">' +
                      '<a class="nav-link"  data-toggle="tab" href="#add3_' + lectures[k][i].id + '" role="tab" aria-controls="contact" aria-selected="false">Açıklama</a>' +
                      '</li>' +
                    '</ul>' +
                    ...
                    '<div class="tab-pane fade" id="add2_' + lectures[k][i].id + '" role="tabpanel" aria-labelledby="profile-tab">' +
                    ...
                    '<span class="kt-input-icon__icon kt-input-icon__icon--left">' +
                      ...
                      '<div class="tab-pane fade" id="add3_' + lectures[k][i].id + '" role="tabpanel" aria-labelledby="contact-tab">' +
                      '<div class="form-group ">' +
                      '<div class="kt-input-icon kt-input-icon--left">' +
                      '<textarea placeholder="+ Add materials" rows="3" class="row col-md-12 kt-ml-0 course_materials_content" id="course_materials_content_' + lectures[k][i].id + '"></textarea>' +
                      '</div>' +
                      '</div>' +
                      '</div>' +
                      '</div>' +
    ...
    const get_session = function () {
        ...
        $.ajax({
            type: 'POST',
            url: '/aajax/get_course_sections',
            dataType: 'json',
            data:{
                cc:$('#section_div').data('cc')
            },
