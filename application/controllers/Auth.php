...
//		$this->session->set_flashdata('message', $this->ion_auth->messages());
//    if (!isset($_SESSION['logged_out']) || isset($_SESSION['logged_out'])) {
      $_SESSION['logged_out'] = "U bent succesvol uitgelogd.";
//    }
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			// insert csrf check
			$this->data['csrf'] = $this->_get_csrf_nonce();
			$this->data['Cron'] = $this->ion_auth->user($id)->row();
	...
	public function create_group()
	{
		...
		// validate form input
		$this->form_validation->set_rules('groupname', $this->lang->line('create_group_validation_name_label'), 'required|alpha_dash');
