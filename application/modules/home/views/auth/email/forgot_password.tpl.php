                ...
                <tr>
                    ...
                    <td align="center" valign="top" style="background: #ffffff;">
                            ...
                            <tr>
                                <td align="left" valign="top">
                                    ...
                                    <a href="#" target="_blank" style="display: block; max-width: 128px;">
                                        <img src="<?= base_url('') ?>img/logo.png" alt="img" width="128" border="0" style="display: block; width: 128px;"/>
                                    </a>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;">
                            <tr>
                                <td align="left" valign="top">
                                    <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 24px; line-height: 32px; font-weight: 300; letter-spacing: -1.5px;">
                    <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 24px; line-height: 32px; font-weight: 300; letter-spacing: -1.5px;">
