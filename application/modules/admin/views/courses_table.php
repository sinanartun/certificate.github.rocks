          ...
          <div class="kt-portlet kt-portlet--mobile">
              ...
              <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                  <div class="kt-portlet__head-actions">
                    <a href="<?php echo base_url('admin/add_new_course')?>" class="btn btn-brand btn-elevate btn-icon-sm">
                      <i class="la la-plus"></i>
                        <?=lang('courses_table_button_add_course')?>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="kt-portlet__body">
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                <thead>
                <tr>
                  <th><?=lang('courses_table_ID')?></th>
                  <th><?=lang('courses_table_course_img')?></th>
                  <th><?=lang('courses_table_title')?></th>
                  <th><?=lang('courses_table_subtitle')?></th>
                  <th><?=lang('courses_table_description')?></th>
                  <th><?=lang('courses_table_active')?></th>
                  <th><?=lang('courses_table_date_added')?></th>
                    <th>Actions</th>
                </tr>
                </thead>
                <tfoot>
                <tr>
                    ...
                    <th><?=lang('courses_table_active')?></th>
                    <th><?=lang('courses_table_date_added')?></th>
                    <th><?=lang('courses_table_actions')?></th>
                </tr>
                </tfoot>
              </table>
...
<script src="/aassets/js/admin/dt_courses_table.js" type="text/javascript"></script>
</body>
<!-- end::Body -->
</html>
