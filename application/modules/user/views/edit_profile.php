                                        ...
                                        <div class="kt-widget kt-widget--user-profile-1">
                                            <div class="kt-widget__head">
                                                <div class="kt-widget__media" >
                                                    <img id="profile_img" src="<?=!empty($the_user->profile_img)?'/uploads/'.$the_user->profile_img:'/assets/media/users/default.jpg';?>" alt="image">
                                                </div>
                                                                    ...
                                                                    <form id="add_user_form" class="kt-form kt-form--label-right" autocomplete="off">
                                                                        ...
                                                                        <div class="kt-portlet__body">
                                                                            ...
                                                                            <div class="form-group form-group-last row <?= empty($the_user) ? 'kt-hidden' : '' ?>">
                                                                                ...
                                                                                <div class="col-lg-10">
                                                                                    <div class="dropzone dropzone-multi" id="dropzone_edit_profile">
...
<script src="/assets/js/edit_profile.1.1.js" type="text/javascript"></script>
