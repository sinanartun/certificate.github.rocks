...
<!--                          </div>-->
                        ...
                        <div class="kt-widget__items">
                          <a href="<?=base_url('u/profile')?>" class="kt-widget__item kt-widget__item--active">
                          ...
                          <a href="<?=base_url('u/edit_profile')?>" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                          ...
                          <div class="kt-widget12__content">
                            ...
                            <div class="kt-widget12__item">
                              <div class="kt-widget12__info">
                                ...
                                <span class="kt-widget12__value"><?=$my_course->title?></span>
                                <span class="kt-widget12__desc"><?=$my_course->course_duration?> </span>
                                <?if(!empty($my_course->tests)):?>
                               
                                <span class="kt-widget12__desc">


                                   <?foreach($my_course->tests as $test):?>

                                  <button class="btn btn-sm btn-info test_result" data-tid="<?=$test->id?>"><?=$test->name?></button>
                                     <p id="test_stats" class="row">
                                       <span>Toplam soru:&nbsp;<strong><?=$test->total_question?></strong></span>
                                       <span>Cevaplanan:&nbsp;<strong><?=$test->answered?></strong></span>
                                       <span>Doğru:&nbsp;<span class="text-success"><strong><?=$test->correct?></strong></span></span>
                                       <span>Yanlış:&nbsp;<span class="text-danger"><strong><?=$test->false?></strong></span></span>
                                     </p>
                                  <?endforeach;?>
                                ...
                                <?endif;?>
                                  ...
                                  <?if(empty($my_course->tests)):?>
                                      <span class="kt-widget12__desc">
                                       ...
                                       <button class="btn btn-sm btn-info no_test_created_btn" data-tid="">Test oluşturulmadı</button>
                                       <p id="test_stats" class="row">
                                       <span>Toplam soru:&nbsp;<strong>0</strong></span>
                                       <span>Cevaplanan:&nbsp;<strong>0</strong></span>
                                       <span>Doğru:&nbsp;<strong>0</strong></span>
                                       <span>Yanlış:&nbsp;<strong>0</strong></span>
                                     </p>
                              ...
                              <div class="kt-widget12__info">
                                <span class="kt-widget12__desc">İlerleme&nbsp;
                                    <span>
                                        [
                                        <?=$my_course->finished_rate==0?'ilerleme görülmedi':''?>
                                        <?=$my_course->finished_rate<100 && $my_course->finished_rate>0?'devam ediliyor':''?>
                                        <?=$my_course->finished_rate==100 || $my_course->finished_rate>100?'bitirildi':''?>
                                         ]
                                    </span>
                                </span>
...
<script src="/assets/js/profile.1.0.js" type="text/javascript"></script>
<!--end::Page Scripts -->
</body>
