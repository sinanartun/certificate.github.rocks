              ...
              <div class="kt-portlet kt-portlet--height-fluid" style="width: 100%;">
                <div class="kt-portlet__body kt-portlet__body--fit">
                  ...
                  <div class="kt-widget kt-widget--project-1">
                    ...
                    <div class="kt-widget__body p-0" style="background-color: #14171c">
                      ...
                      <ul class="kt-sticky-toolbar">
                        <li class="kt-sticky-toolbar__item kt-sticky-toolbar__item--success" id="kt_demo_panel_toggle">
                          <a href="#" class=""><i class="flaticon2-left-arrow "></i></a>
                        </li>
                      </ul>

                      <video
                              id="lecture_video_player"
                              class="video-js vjs-paused vjs-controls-enabled vjs-big-play-centered vjs-user-active row-full "
                              controls
                              preload="auto"
                              poster="/aassets/media/misc/garen-bg-1.png"
                              data-setup="{}"
                      >
                        <source src="/videos/Awaken_lol_1080p.mp4" type="video/mp4"/>
                                ...
                                <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-info nav-tabs-line-2x nav-tabs-line-right" role="tablist">
                                  ...
                                  <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#kt_portlet_base_demo_3_3_tab_content" role="tab" aria-selected="false">
                                      <i class="" aria-hidden="true"></i>Bookmarks
                                    </a>
                                  </li>
                                </ul>
                              </div>
                                    ...
                                    <div class="kt-widget3">
                                      <div class="row kt-widget3__item kt-pb-20">
                                        <div class="col-md-12">
                                          <div class="kt-widget3__info">
                                            <span class="kt-widget3__time" style="font-size: 18px; color: black; font-weight: bold">Bu Kurs Hakkında</span>
                                            <p></p>
                                            <span class="kt-widget3__time">Sıfırdan React 'a ve Context Api 'ye giriş yaparak ilk uygulamanızı oluşturun.</span>
                                          </div>
                                        </div>
                                      ...
                                      <div class="row kt-widget3__item kt-pb-20 kt-pt20">
                                        ...
                                        <div class="col-md-10">
                                          ...
                                          <div class="kt-widget3__text row kt-pb-5 kt-pl10">Öğrenci: 29716</div>
                                          ...
                                          <div class="kt-widget3__text row kt-pb-5 kt-pl10">Dersler: <?= count($course_qa) ?></div>
                                          <div class="kt-widget3__text row kt-pb-5 kt-pl10">Video: 5 saat</div>
                                        </div>
                                      </div>
                                      <div class="row kt-widget3__item kt-pb-20 kt-pt20">
                                        <div class="col-md-2">
                                ...
                                <div class="tab-pane" id="kt_portlet_base_demo_2_2_tab_content" role="tabpanel">
                                  ...
                                  <div class="kt-portlet__body">
                                    ...
                                    <div class="input-group col-xl-12 kt-pb-10 kt-pt-0 kt-pl0" style="padding-right: 1px">
                                      <input type="text" id="section_name" name="section_name" class="form-control" placeholder="Questions name">
                                      <div class="input-group-append">
                                        <button class="btn btn-primary" type="button" id="add_section">Search</button>
                                      </div>
                                    </div>
                                    ...
                                    <div class="row kt-pl0 kt-pb-50">
                                      ...
                                      <div class="dropdown col-md-4">
                                        <button class="btn btn-secondary dropdown-toggle col-xl-12" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                          Tüm dersler
                                        </button>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                          <a class="dropdown-item" href="javascript:;" data-container="body">Tüm dersler</a>
                                          <a class="dropdown-item" href="javascript:;">Geçerli ders</a>
                                        </div>
                                      </div>

                                      <div class="dropdown col-md-4">
                                        <button class="btn btn-secondary dropdown-toggle col-xl-12" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                          Güncelliğe göre sırala
                                        </button>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                          <a class="dropdown-item" href="javascript:;" data-placement="right" data-skin="dark" data-container="body">Güncelliğe göre sırala</a>
                                          <a class="dropdown-item" href="javascript:;">En çok olumlu oy verilene göre sırala</a>
                                          <a class="dropdown-item" href="javascript:;">Önerilenlere göre sırala</a>
                                        </div>
                                      </div>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                          <div class="dropdown-item">
                                            <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand">
                                              <input type="checkbox">Takip ettiğim sorular
                                              <span></span>
                                            </label>
                                          </div>
                                          ...
                                          <div class="dropdown-item">
                                            <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand">
                                              <input type="checkbox">Sorduğum sorular
                                              <span></span>
                                            </label>
                                          </div>
                                          ...
                                          <div class="dropdown-item">
                                            <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand">
                                              <input type="checkbox">Cevaplanmamış sorular
                                              <span></span>
                                            </label>
                                          </div>
                                    ...
                                    <div class="row kt-pl10 kt-pb-50">
                                      ...
                                      <div class="col-md-12">
                                        <div class="pull-left kt-pl0 kt-pt9 ask_and_question_count">
                                          <font style="font-weight: 700; color: rgba(80,87,99,0.8); font-size: 16px; font-family: open sans,helvetica neue,Helvetica,Arial,sans-serif;">Bu kursta <?= count($course_qa) ?> soru mevcut</font>
                                        </div>


                                        <button class="pull-right kt-mr-0" id="ask_question_btn">
                                          <font style="font-weight: 700; font-size: 14px; font-family: open sans,helvetica neue,Helvetica,Arial,sans-serif;">Yeni bir soru sorun</font></i><i class="flaticon2-chat-2 kt-pl5"
                                    ...
                                    <div class="row kt-pb-30 kt-pl0 kt-pr0 kt-hidden" id="yasuo_div">
                                      <div class="col-md-12">
                                    ...
                                    <div class="kt-widget3" id="question_answers">
                                      <? foreach ($course_qa as $k => $qa): ?>
                                        <div class="kt-widget3__item">
                                          <div class="kt-widget3__header">
                                            <div class="kt-widget3__user-img">
                                              <img class="kt-widget3__img" src="<?= base_url('uploads/thumb_' . $qa->profile_img) ?>" alt="">
                                            </div>
                                            <div class="kt-widget3__info">
                                              <a href="#" class="kt-widget3__username"><?= $qa->first_name; ?> <?= $qa->last_name; ?></a><br>
                                              <span class="kt-widget3__time"><?= $qa->ago; ?></span>
                                            </div>
                                            <span class="kt-widget3__status kt-font-info" data-qid="<?= $qa->id; ?>"  data-course_code="<?= $course->course_code; ?>">
                                                  <span class="like_count"><?= $qa->like; ?></span>
                                                  <button class="btn btn-secondary btn-pill like_question" ><i class="flaticon-like"></i></button>
                                                  <span id="answers_count"><?= $qa->answer_count; ?></span>
                                                  <button class="btn btn-secondary btn-pill comment_count"><i class="flaticon-comment"></i></button>
                                              <?if($qa->user_id === $the_user->id):?>
                                              ...
                                              <button type="button" class="btn btn-success btn-sm ask_question_view" >Cevapları Gör</button>
                                          </span>
                                          </div>
                                          <div class="kt-widget3__body">
                                            <span class="kt-widget3__text"><?=$qa->text?></span>
                                          </div>
                                        </div>
                                      <? endforeach; ?>
                                    </div>
                                    ...
                                    <div class="kt-widget3">
                                      <div class="kt-widget3__item">
                                        <div class="kt-widget3__header">
                                          ...
                                          <div class="kt-widget3__info">
                                            <a href="#" class="kt-widget3__username">Melania Trump</a><br>
                                      ...
                                      <div class="kt-widget3__item">
                                        <div class="kt-widget3__header">
                                          ...
                                          <div class="kt-widget3__info">
                                            <a href="#" class="kt-widget3__username">Lebron King James</a><br>
    ...
    <div class="kt-demo-panel__item ">
      <div class="accordion accordion-light  accordion-toggle-arrow" id="sections_list">
        <? foreach ($course->sections as $section): ?>
          <div class="card">
            <div class="card-header" style="background-color: rgba(245,246,252,0.91); padding: 5px 10px 5px 10px" id="_<?= $section->id ?>">
              <div class="card-title collapsed kt-pb-0" data-toggle="collapse" data-target="#s<?= $section->id ?>" aria-expanded="false" aria-controls="s<?= $section->id ?>">
                <span><?= $section->name ?></span>

              </div>
              <span class="pull-left"><small><?= !empty($section->media_duration) ? $section->media_duration : '' ?></small></span>
            </div>
            <div id="s<?= $section->id ?>" class="collapse kt-pt10" aria-labelledby="_<?= $section->id ?>" data-parent="" style="">

              <div class="card-body">
                <div class="kt-notification kt-notification--fit">
                  <? foreach ($section->lectures as $lecture): ?>
                    <a href="javascript:;" data-type="<?= $lecture->media_type ?>" data-media="<?= $lecture->media_url ?>" data-media_title="<?= $lecture->name ?>" data-lid="<?= $lecture->id; ?>" class="kt-notification__item lecture_box"
...
<script src="/assets/js/play.js" type="text/javascript"></script>
