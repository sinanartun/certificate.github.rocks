...
<div class="kt-grid kt-grid--hor kt-grid--root">
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
      ...
      <?php $this->load->view('shared/left_menu'); ?>
        <!-- end:: Aside -->
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper kt-pt65" id="kt_wrapper" style="min-height: 920px;">
            <!-- begin:: Header -->
                                                    ...
                                                    <div class="kt-form__section kt-form__section--first">
                                                        <div class="kt-wizard-v1__form">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="course_title" name="course_title" placeholder="<?=lang('add_new_course_course_title')?>" value="<?=(!empty($course))?$course->title:''?>">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="course_subtitle" name="course_subtitle" placeholder="<?=lang('add_new_course_course_subtitle')?>" value="<?=(!empty($course))?$course->sub_title:''?>">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="course_description" type="text" class="form-control" name="course_description" ><?=(!empty($course))?$course->description:''?></textarea>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <select class="form-control" id="category" name="category">
                                                                        <optgroup label="<?=lang('development');?>">
                                                                            <option value="web_development" <?=(!empty($course) && !empty($course->sub_category))?($course->sub_category==='web_development'?'selected':''):''?>><?=lang('web_development');?></option>
                                                                            <option value="mobile_apps" <?=(!empty($course) && !empty($course->sub_category))?(($course->sub_category==='mobile_apps')?'selected':''):''?>><?=lang('mobile_apps');?></option>
                                                                            <option value="programing_languages" <?=(!empty($course) && !empty($course->sub_category))?(($course->sub_category==='programing_languages')?'selected':''):''?>><?=lang('programing_languages');?></option>
                                                                            <option value="databases" <?=(!empty($course) && !empty($course->sub_category))?(($course->sub_category==='databases')?'selected':''):''?>><?=lang('databases');?></option>
                                                                        </optgroup>
                                                                        <optgroup label="<?=lang('data_science');?>">
                                                                            <option value="artificiell_intelligens" <?=(!empty($course) && !empty($course->sub_category))?(($course->sub_category==='artificiell_intelligens')?'selected':''):'';?>><?=lang('artificiell_intelligens');?></option>
                                                                        </optgroup>
                                                                        <optgroup label="<?=lang('big_database');?>">
                                                                            <option value="hadoop" <?=(!empty($course) && !empty($course->sub_category))?(($course->sub_category==='hadoop')?'selected':''):''?>>Hadoop</option>
                                                                            <option value="spark" <?=(!empty($course) && !empty($course->sub_category))?(($course->sub_category==='spark')?'selected':''):''?>>spark</option>
                                                                            <option value="elasticsearch" <?=(!empty($course) && !empty($course->sub_category))?(($course->sub_category==='elasticsearch')?'selected':''):''?>>Elasticsearch</option>
                                                                        </optgroup>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="kt-wizard-v1__form">
                                                            <div class="form-group row">
                                                                ...
                                                                <div id="course_img_div" class="col-md-12">
                                                                    ...
                                                                    <img id="add_course_img" style="width: 100%;max-width: 100%;max-height: 400px" src="<?= !empty($course->course_img) ? $course->course_img : '/uploads/default.jpg' ?>">
                                                                    <hr>
                            ...
                            <div class="kt-portlet__body h-100" style="min-width: 517px;">
                                ...
                                <div class="kt-portlet h-100">
                                    ...
                                    <div class="kt-portlet__body h-100">
                                        <div class="row">
                                            <div id="section_div" class="col-md-12 scroller_add_new_crs" data-cc="<?= $course->course_code ?>"></div>
                                        </div>
                ...
                <div class="modal fade" id="kt_modal_6" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer kt-mt-70">
...
<script src="/aassets/js/admin/edit_course.js" type="text/javascript"></script>
