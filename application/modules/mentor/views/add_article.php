            ...
            <form class="kt-form kt-form--fit kt-form--label-right">
              <div class="kt-portlet__body">
                <div class="form-group row">
                  <label for="article_name" class="col-1 col-form-label text-left"><?=lang('add_article_name')?></label>
                  <div class="col-4">
                    <input class="form-control" type="text" value="" id="article_name" maxlength="100">
                    <span class="form-text text-muted"><?=lang('add_article_comment')?></span>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
              ...
              <div class="kt-portlet__foot">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <button type="button" id="save" class="btn btn-brand pull-right"><?=lang('add_article_button_save_draft')?></button>
                    <button type="button" id="clear" class="btn btn-secondary pull-right kt-mr-10"><?=lang('add_article_button_clear')?></button>
                    <button type="button" id="save_draft" class="btn btn-warning pull-right kt-mr-10"><?=lang('add_article_button_submit')?></button>
...
<script src="/aassets/js/admin/add_article.js" type="text/javascript"></script>
</body>
<!-- end::Body -->
</html>
