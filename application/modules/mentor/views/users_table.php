...
<div class="kt-grid kt-grid--hor kt-grid--root">
  <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper kt-pt65" id="kt_wrapper">
      <!-- begin:: Header -->
      <div id="m_kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
        <!-- begin:: Header Menu -->
          ...
          <div class="kt-portlet kt-portlet--mobile">
                  ...
                  <div class="kt-portlet__head-actions">
                    ...
                    <a href="<?php echo base_url('admin/add_user')?>" class="btn btn-brand btn-elevate btn-icon-sm">
                      <i class="la la-plus"></i>
                        <?=lang('users_table_button_add_user')?>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="kt-portlet__body">
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                <thead>
                <tr>
                  <th><?=lang('users_table_id')?></th>
                  <th><?=lang('users_table_fullname')?></th>
                  <th><?=lang('users_table_active')?></th>
                  <th><?=lang('users_table_group')?></th>
                  <th><?=lang('users_table_lastlogin')?></th>
                  <th><?=lang('users_table_ip')?></th>
                  <th><?=lang('users_table_joindate')?></th>
                    <th>Actions</th>
                </tr>
                </thead>
                <tfoot>
                <tr>
                    ...
                    <th><?=lang('users_table_ip')?></th>
                    <th><?=lang('users_table_joindate')?></th>
                    <th><?=lang('users_table_actions')?></th>
                </tr>
                </tfoot>
              </table>
...
<script src="/aassets/js/mentor/dt_users_table.js" type="text/javascript"></script>
</body>
<!-- end::Body -->
</html>
