                    ...
                    <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                                <thead>
                                <tr>
                                    <th><?=lang('error_log_id')?></th>
                                    <th><?=lang('error_log_type')?></th>
                                    <th><?=lang('error_log_time')?></th>
                                    <th><?=lang('error_log_log')?></th>
                                    <th>Actions</th>
                                </tr>
                                </thead>
                                <tfoot>
...
<script src="/aassets/js/admin/dt_error_log_table.js" type="text/javascript"></script>
</body>
<!-- end::Body -->
</html>
