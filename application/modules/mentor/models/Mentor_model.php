<?php defined('BASEPATH') OR exit('No direct script access allowed');
  ...
  class Mentor_model extends CI_Model {
    ...
    public function submit_new_course()
    {
      ...
      if (strlen($draft->description) < 20) {
        return $this->re('e', 'Course Description must be at least 20 characters Length');
      }
      ...
      $sections = json_decode($draft->sections);
    ...
    public function save_sess_add_new_course(): \stdClass
    {
      $user_id = $this->ion_auth->get_user_id();
...
//      $conf_img['width'] = 220;
    ...
    public function update_sess_question()
    {
      ...
      $res = $this->db->where('id', $qid)->update('___test_questions_sess', $data);
...
//        echo  $new_file_name;die;
    ...
    public function get_test($sess = FALSE)
    {
      $user_id = $this->ion_auth->get_user_id();
      if ($sess) {
        $test_table = '___tests_sess';
